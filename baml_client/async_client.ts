...
export class BamlAsyncClient {
  ...
  async GenerateRandomNumber(
    ...
    try {
      ...
      if (options.onTick) {
        const stream = this.stream.GenerateRandomNumber(
      ...
      return raw.parsed(false) as types.RandomNumber
    } catch (error) {
...
class BamlStreamClient {
  ...
  GenerateRandomNumber(
      ...
      __baml_options__?: BamlCallOptions
  ): BamlStream<partial_types.RandomNumber, types.RandomNumber> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const signal = options.signal;
        ...
        onTickWrapper = () => {
          ...
          if (log) {
            try {
              ...
              console.error("Error in onTick callback for GenerateRandomNumber", error);
            }
          }
        };
      }
      ...
      return new BamlStream<partial_types.RandomNumber, types.RandomNumber>(
        raw,
        (a): partial_types.RandomNumber => a,
        (a): types.RandomNumber => a,
        this.ctxManager.cloneContext(),
        options.signal,
      )
    } catch (error) {
